...
pub fn main() -> Result<(), Error> {
    ...
    let window = {
        ...
        WindowBuilder::new()
            .with_title("Verlet Demo - Simple Cloth")
...
fn init_cloth(verlet_phy: &mut VerletPhysics2D) {
    let mut cloth = VerletObject2D::new("cloth");

    objects::create_sheet(
        &mut cloth,
        Vector2D::new(200., 200.), // center
        150.,
        150.,
        10,
        0.5,
    );
    verlet_phy.add_verlet_object(cloth);
}
